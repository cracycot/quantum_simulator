/**
 * Автоматические тесты для QEC Simulator
 * Проверяют корректность работы всех модулей
 */
...
// Утилита для округления fidelity
...
// ============================================
// ТЕСТ 1: 3-кубитный код - одиночная X-ошибка
// ============================================
...
// Код НЕ должен исправить 2 ошибки - fidelity должна быть низкой
const test2Passed = fidelity2 < 0.5; // Ожидаем < 50%
...
// ============================================
// ТЕСТ 3: 3-кубитный код - Z-ошибка (ОГРАНИЧЕНИЕ)
// ============================================
...
// Синдром должен быть (0,0) - ошибка не обнаружена
...
// ============================================
// ТЕСТ 4: Код Шора - X-ошибка (bit-flip)
// ============================================
...
// ============================================
// ТЕСТ 5: Код Шора - Z-ошибка (phase-flip)
// ============================================
...
// Phase-flip синдром НЕ должен быть [0,0]
...
// ============================================
// ТЕСТ 6: Код Шора - Y-ошибка (combined)
// ============================================
...
// Должны быть обнаружены ОБЕ компоненты
...
// ============================================
// ТЕСТ 7: Код Шора - 2 ошибки в разных блоках
// ============================================
...
// Найдём, какие кубиты получили ошибки
const erroredQubits = result7.errorsApplied
  .filter(e => e.applied)
  .map(e => e.qubitIndex);
console.log(`✓ Ошибки на кубитах: ${erroredQubits.join(', ')}`);

// Определим, в каких блоках ошибки (блок 0: q0-2, блок 1: q3-5, блок 2: q6-8)
...
if (differentBlocks) {
  // Если в разных блоках - должна исправить
  ...
  // Если в одном блоке - может не справиться
